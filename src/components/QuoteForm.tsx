  ...
  return (
    <div id="quote-form" className="container mx-auto px-4 relative -mt-32 md:-mt-40 mb-16">
      <div className="bg-white rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] transform transition-all hover:shadow-[0_25px_60px_rgba(0,0,0,0.35)] hover:-translate-y-1 overflow-hidden max-w-3xl mx-auto">
        <div className="p-1">
          <div 
            className="bg-gradient-to-r from-brown-light to-brown/80 rounded-t-lg p-6 border-b border-gray-200"
          >
            <div className="flex items-center space-x-4">
              <div className="h-14 w-14 bg-orange rounded-full flex items-center justify-center shadow-lg">
                <Phone className="h-7 w-7 text-white" />
              </div>
              <div>
                <h2 className="text-2xl font-bold text-white">Get Your Free Quote</h2>
                <p className="text-white/80">Fill out this form and I'll get back to you within 24 hours</p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-5">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  required 
                  className="border-gray-300 focus:ring-brown focus:border-brown"
                />
              </div>
              <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <select
                id="service"
                className="flex h-10 w-full rounded-md border border-gray-300 bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:border-brown focus:ring-2 focus:ring-brown"
                required
              >
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                className="min-h-[100px] border-gray-300 focus:ring-brown focus:border-brown"
                required
              />
            </div>
            ...
            <Button 
              type="submit" 
              className="w-full bg-gradient-to-r from-brown to-brown-dark hover:from-brown-dark hover:to-brown text-white font-semibold py-3"
            >
              Get My Free Quote
            </Button>
          </form>
